...
const StartNodeWrapper = React.memo(({ data, id, onAddNode, draggable = true, ...rest }: NodeWrapperProps) => (
  <div className="group">
    <MemoizedStartNode data={data} id={id} {...rest} draggable={draggable} />
...
const SignalNodeWrapper = React.memo(({ data, id, onDelete, onAddNode, draggable = true, ...rest }: NodeWrapperProps) => (
  <div className="group">
    <MemoizedSignalNode data={data} id={id} {...rest} draggable={draggable} />
...
const ActionNodeWrapper = React.memo(({ data, id, onDelete, onAddNode, updateNodeData, draggable = true, ...rest }: NodeWrapperProps & { updateNodeData?: (id: string, data: any) => void }) => {
  ...
  return (
    <div className="group">
      <MemoizedActionNode data={enhancedData} id={id} {...rest} draggable={draggable} />
...
const EntryNodeWrapper = React.memo(({ data, id, onDelete, onAddNode, updateNodeData, draggable = true, ...rest }: NodeWrapperProps & { updateNodeData?: (id: string, data: any) => void }) => {
  // Enhance data with updateNodeData function and ensure positions is always defined
  const enhancedData = React.useMemo(() => ({
    ...data,
    updateNodeData,
  ...
  return (
    <div className="group">
      <MemoizedEntryNode data={enhancedData} id={id} {...rest} draggable={draggable} />
...
const ExitNodeWrapper = React.memo(({ data, id, onDelete, onAddNode, updateNodeData, draggable = true, ...rest }: NodeWrapperProps & { updateNodeData?: (id: string, data: any) => void }) => {
  // Enhance data with updateNodeData function and ensure positions is always defined
  const enhancedData = React.useMemo(() => ({
    ...data,
    updateNodeData,
  ...
  return (
    <div className="group">
      <MemoizedExitNode data={enhancedData} id={id} {...rest} draggable={draggable} />
...
const AlertNodeWrapper = React.memo(({ data, id, onDelete, onAddNode, updateNodeData, draggable = true, ...rest }: NodeWrapperProps & { updateNodeData?: (id: string, data: any) => void }) => {
  // Enhance data with updateNodeData function and ensure positions is always defined
  const enhancedData = React.useMemo(() => ({
    ...data,
    updateNodeData,
  ...
  return (
    <div className="group">
      <MemoizedAlertNode data={enhancedData} id={id} {...rest} draggable={draggable} />
...
const EndNodeWrapper = React.memo(({ data, id, onDelete, draggable = true, ...rest }: NodeWrapperProps) => (
  <div className="group">
    <MemoizedEndNode data={data} id={id} {...rest} draggable={draggable} />
    <MemoizedNodeControls node={{ id, type: 'endNode', data }} onDelete={onDelete} />
  </div>
));
EndNodeWrapper.displayName = 'EndNodeWrapper';

const ForceEndNodeWrapper = React.memo(({ data, id, onDelete, draggable = true, ...rest }: NodeWrapperProps) => (
  <div className="group">
    <MemoizedForceEndNode data={data} id={id} {...rest} draggable={draggable} />
