...
const Canvas = {
  MinimapControl: ({ visible, onToggle }: { visible: boolean, onToggle: () => void }) => (
    <div className="absolute bottom-6 right-6 z-10 flex flex-col gap-1">
      <Button 
        ...
        type="button"
      >
        {visible ? <Minimize2 className="h-3.5 w-3.5" /> : <Maximize2 className="h-3.5 w-3.5" />}
      </Button>
