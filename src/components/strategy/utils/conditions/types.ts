...
export interface TimeFunctionExpression extends BaseExpression {
  type: 'time_function';
  function: string; // 'today' | 'yesterday' | 'n_seconds_ago' | 'n_minutes_ago' | 'n_hours_ago' | 'n_days_ago' | 'specific_date' | 'specific_datetime' | 'specific_time' | 'this_week' | 'last_week' | 'this_month' | 'last_month';
  parameters?: any; // number for n_X_ago functions, Date object for specific_date, TimeObject for specific_time
}
